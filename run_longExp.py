...
def main():
    ...
    # parser.add_argument('--tfactor', type=int, default=1, help='tfactor')

    #MWD
    parser.add_argument('--wavelet_layers', type=int, default=5, help='wavelet_layers')
    parser.add_argument('--wavelet_type', type=str, default='haar', help='wavelet_type')
    parser.add_argument('--wavelet_mode', type=str, default='zero', help='wavelet_mode')
    parser.add_argument('--wavelet_dim', type=int, default=64, help='wavelet_dim')
    parser.add_argument('--SmoothL1Loss_beta', type=float, default=1.0, help='beta of SmoothL1Loss')
    parser.add_argument('--hidden_wavelet_dim', type=int, default=64, help='hidden_wavelet_dim')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            print('>>>>>>>start training : {} | wavelet_type: {} >>>>>>>>>>>>>>>>>>>>>>>>>'.format(setting,args.wavelet_type))


            exp.train(setting)

            #print('>>>>>>>testing : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
            print('>>>>>>>testing : {} | wavelet_type: {} <<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting, args.wavelet_type))

            exp.test(setting)

            if args.do_predict:
                #print('>>>>>>>predicting : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
                print('>>>>>>>predicting : {} | wavelet_type: {} <<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting, args.wavelet_type))
